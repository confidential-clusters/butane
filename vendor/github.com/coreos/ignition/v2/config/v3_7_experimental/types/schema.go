...
// generated by "schematyper --package=types config/v3_7_experimental/schema/ignition.json -o config/v3_7_experimental/types/schema.go --root-type=Config" -- DO NOT EDIT
